<template>
    <div class="bg-gray-50 dark:bg-background-800/50 border dark:border-background-700 p-4 rounded-lg flex flex-col gap-2">
        ...
        <h2 class="dark:text-white font-medium">{{ project.title }}</h2>
        <div class="flex flex-wrap gap-2">
            <span v-for="l in project.langs" class="px-2 py-0.5 rounded bg-gray-300 dark:bg-background-600 text-xs dark:text-white">
                # {{l}}
            </span>
        </div>
