...
export const skills = [
  {
    ...
    programs: [
      ...
      { title: "React Native", icon: "/devsvg/react-js-icon.svg" },
    ],
  },
  {
    title: "Бек энд",
    programs: [
      ...
      { title: "Python", icon: "/devsvg/python.svg" },
      { title: "Flask", icon: "/devsvg/flask.svg" },
    ],
  },
  {
    title: "Другие",
    programs: [
      ...
      { title: "Jest", icon: "/devsvg/jest.svg" },
      { title: "Mocha", icon: "/devsvg/mocha.svg" },
      { title: "Elastic S.", icon: "/devsvg/elastic-search.svg" },
    ],
  },
];
...
export const projects = [
  ...
  {
    title:
      "Электронный склад - десктоп программа для магазина электротехники (Паярик)",
    url: "",
    github: "",
...
export const aboutCards = [
  ...
  },
  {
    ...
    description:
      "Я окончил Ташкентский информационный технологический университет Самаркандский филиал по специальности Программный инжинеринг. Помимо формального образования, я постоянно повышаю свою квалификацию, проходя различные хакатоны и получая сертификаты. Среди хакатоны я участвовал — President Tech Awards, Tech Genius, Hacknovation, United Clean Coders и другие.",
  },
  {
    icon: LiDiamond,
    title: "Цели и стремления",
    description:
      "Моя основная цель — создавать высококачественные и эффективные веб-приложения, которые улучшают жизнь пользователей. Я стремлюсь к постоянному профессиональному росту и развитию, участвуя в интересных проектах и сотрудничая с талантливыми командами.",
  },
];

export const socialLinks = [
  {
    icon: CoBrandTelegramPlane,
    title: "Telegram",
    name: "t.me/nurbek_xd",
    url: "https://t.me/nurbek_xd",
  },
  {
    icon: CoBrandFacebookF,
    title: "Facebook",
    name: "facebook/Nurbek",
    url: "https://www.facebook.com/profile.php?id=100073779323449",
  },
  {
    icon: CoBrandInstagram,
    title: "Instagram",
    name: "instagram/nurbek_developer_",
    url: "https://www.instagram.com/nurbek_developer_/",
  },
  {
    icon: CoBrandGithub,
    title: "Github",
    name: "github/Nurbek12",
    url: "https://github.com/Nurbek12",
  },
  {
    icon: CoBrandLinkedinIn,
    title: "Linkedin",
    name: "linkedin/nurbek-rustamov-7111a6224",
    url: "https://www.linkedin.com/in/nurbek-rustamov-7111a6224",
  },
];
